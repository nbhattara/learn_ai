...
cleaned_df = clean_dataset(
    df,
    date_columns=['order_date', 'signup_date', 'last_activity'],      # ← put your date columns here
    numeric_columns=['price', 'quantity', 'discount', 'revenue'],     # ← explicit numeric columns (optional)
